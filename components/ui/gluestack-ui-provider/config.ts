...
export const config = {
  light: vars({
    /* Primary (Blue) */
    '--color-primary-0': '239 244 255',
    '--color-primary-50': '219 230 255',
    '--color-primary-100': '199 217 255',
    '--color-primary-200': '159 191 255',
    '--color-primary-300': '119 164 255',
    '--color-primary-400': '89 142 255',
    '--color-primary-500': '59 120 255', // #3B78FF (base)
    '--color-primary-600': '49 102 217',
    '--color-primary-700': '39 84 179',
    '--color-primary-800': '29 66 140',
    '--color-primary-900': '20 48 102',
    '--color-primary-950': '13 30 64',
